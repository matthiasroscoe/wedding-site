        ...
        <section id="schedule" className="text-brown-dark bg-[#e1cf73]">
            <div className="container mx-auto px-8 pt-[140px] pb-14 md:pt-[240px] md:pb-24">
                <div className="mb-24 md:mb-32">
                    <h2 className="font-handwriting mb-8 text-center text-[32px] leading-[38px] md:mb-14">
                        Wedding Day
                    </h2>
                    ...
                    <div className="grid grid-cols-1 gap-8 text-center md:grid-cols-6 md:gap-y-14">
                        {weddingDayItems.map((item) => (
                            <div key={item.name} className={item.colClass}>
                                <p className="font-handwriting text-2xl leading-8">{item.time}</p>
                                <p className="font-handwriting mt-2 text-2xl leading-8">
                                    {item.name}
                                </p>
                            </div>
                        ))}
                ...
                <div className="mb-24">
                    ...
                    <div className="flex flex-col items-center">
                        <p className="font-handwriting text-2xl leading-8">2pm</p>
                        <p className="font-handwriting mt-2 text-2xl leading-8">
                            Paella &amp; Pool Party
                        </p>
                        <div>
                            ...
                            <p className="font-body mt-0 text-base leading-8">
